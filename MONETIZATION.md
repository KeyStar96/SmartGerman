...
- A1.1-Vokabelinhalt (Lektion 1/2 statt „Schritte plus neu“) ändert den Stripe-Workflow nicht. Paywall bleibt am `subscription_status`, nicht an einzelnen Karten.
