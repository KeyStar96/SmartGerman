            ...
            <div className="flex-1 flex flex-col min-h-0 relative w-full lg:h-full">
                ...
                <header className="px-6 md:px-12 py-8 shrink-0 z-10">
                    <div className="flex justify-between items-start mb-6">
                        ...
                        <div className="bg-[#010101] px-3 py-1.5 md:px-4 md:py-2 rounded-full border border-white/10 shadow-lg flex items-center justify-center overflow-hidden">
                            <Image
                                ...
                                height={48}
                                priority
                                className="object-contain w-auto h-8 md:h-12 scale-[1.35] mix-blend-screen"
                            />
                        </div>
                    </div>
