...
export default function WhyUsBento({ dictionary }: { dictionary: WhyUsDictionary }) {
    ...
    return (
        <section ref={containerRef} className="relative py-32 bg-transparent">
            ...
            <div className="absolute top-1/2 left-0 -translate-y-1/2 w-[600px] h-[600px] bg-[radial-gradient(circle,rgba(255,92,0,0.1)_0%,transparent_60%)] dark:bg-[radial-gradient(circle,rgba(255,92,0,0.08)_0%,transparent_60%)] rounded-full pointer-events-none -z-10" />
