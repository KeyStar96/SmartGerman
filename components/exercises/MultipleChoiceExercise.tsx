    ...
    <div className="p-5 sm:p-10">
          ...
          return (
            <button
              ...
              className={cn(
                ...
                !isCorrectAndSolved && isExcluded && 'cursor-not-allowed border-gray-200 bg-gray-100 text-gray-400 line-through',
                !isCorrectAndSolved && !isExcluded && isSelected && 'border-blue-600 bg-blue-600 text-white shadow-lg',
                !isCorrectAndSolved && !isExcluded && !isSelected && 'border-gray-300 bg-white text-gray-900 hover:border-blue-400 hover:bg-blue-50'
              )}
            >
              {option}
            </button>
      ...
      {isSolved && (
        <div
          role="status"
          aria-live="polite"
          className="mt-8 flex items-center gap-4 rounded-2xl border-2 border-green-200 bg-green-50 p-6"
        >
