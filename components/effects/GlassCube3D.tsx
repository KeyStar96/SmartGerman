 ...
 * - Canvas mit Performance-Optimierungen
 * - Environment Map (Preset "studio", background={false})
 ...
 * 
 * HINWEIS: MeshTransmissionMaterial verzerrt alles HINTER dem Mesh im Scene-Graph.
 * Der Text wird als HTML-Overlay über dem Canvas gerendert, während der Webseiten-Hintergrund
 * durch das Glas verzerrt wird. Für echte Text-Verzerrung müsste der Text als Texture
 * in den Scene-Graph gerendert werden.
 */
export default function GlassCube3D({ 
  ...
  return (
    <div className={`relative w-full h-full ${className}`} style={{ minHeight: "400px" }}>
      ...
      {/* 3D Canvas - Glas-Würfel verzerrt den Webseiten-Hintergrund */}
      <Canvas
