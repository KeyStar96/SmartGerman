-- A1.1 Lektion 3: Lebensmittel, Geschäfte, Mengen, Verben, Grammatik & Redemittel beim Einkaufen
-- Kann eigenständig ausgeführt werden, um Lektion 3 (A1.1) zu befüllen oder zurückzusetzen.

DELETE FROM public.vocabulary_cards
WHERE level = 'A1.1' AND lesson = 'Lektion 3';
