...
export default async function VocabularyOverviewPage({
  ...
  return (
    <div className="mx-auto flex max-w-4xl flex-col rounded-3xl bg-white p-5 shadow-sm ring-1 ring-gray-900/5 sm:p-8 lg:h-[calc(100vh-5rem)] lg:overflow-hidden">
      {/* Fixer Kopfbereich: bleibt auf Desktop stehen, nur die Lektionsliste darunter scrollt intern. */}
      ...
      {/* Scrollbarer Bereich: nur dieser Teil scrollt auf Desktop, nie die ganze Seite. */}
