      ...
      <div className="flex min-h-[26rem] flex-col overflow-hidden rounded-3xl bg-white shadow-xl ring-1 ring-gray-900/10">
        ...
        {isRevealed ? (
          <div className="flex flex-col items-center justify-center bg-white p-6 sm:p-10">
            ...
            {card.plural && (
              <p className="mt-3 text-2xl text-gray-500">{t('plural_label', { plural: card.plural })}</p>
            )}
            ...
            {feedback ? (
              <div
                ...
                aria-live="polite"
                className={cn(
                  'mt-10 w-full rounded-2xl border-2 p-6 text-center',
                  feedback.movedBack
              ...
              <div className="mt-10 flex w-full flex-col gap-4 sm:flex-row sm:gap-6">
                <button
                  ...
                  className="flex min-h-16 flex-1 flex-col items-center justify-center rounded-2xl border-2 border-amber-300 bg-amber-50 py-6 text-amber-800 transition-colors hover:bg-amber-100 disabled:opacity-60 focus-visible:outline focus-visible:outline-4 focus-visible:outline-offset-2 focus-visible:outline-[#FF5C00]"
                >
          ...
          <div className="flex items-center justify-center bg-white p-6 sm:p-10">
            <button
              ...
              className="w-full rounded-2xl bg-blue-600 py-8 text-2xl font-bold text-white shadow-md transition-all hover:bg-blue-500 hover:shadow-lg focus-visible:outline focus-visible:outline-4 focus-visible:outline-offset-2 focus-visible:outline-[#FF5C00]"
            >
              {t('reveal_solution')}
            </button>
          </div>
